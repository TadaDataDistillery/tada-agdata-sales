...
resource "aws_lakeformation_resource" "data_product" {
  arn = module.tada_agdata_sales_dataset_s3.s3_bucket_arn
}

resource "aws_lakeformation_resource" "sales_report" {
  arn = module.tada_agdata_sales_app_s3.s3_bucket_arn
}

resource "aws_lakeformation_resource" "grower_extract" {
  arn = module.tada_agdata_grower_extract_app_s3.s3_bucket_arn
}
